...
#[Fillable(['name', 'email', 'password', 'role', 'apellidos', 'telefono', 'profesion', 'avatarUrl', 'is_active', 'domicilio', 'codigo_postal', 'ciudad', 'provincia', 'latitude', 'longitude', 'fcm_token'])]
